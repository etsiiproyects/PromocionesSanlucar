...
CREATE TABLE DEMANDAS (
    ...
    FOREIGN KEY (EMAIL) REFERENCES USUARIOS ON DELETE CASCADE,
...
CREATE OR REPLACE PROCEDURE INSERTAR_DEMANDA 
    ...
    W_EMAIL IN DEMANDAS.EMAIL%TYPE,
    W_OIDO IN DEMANDAS.OID_O%TYPE) IS
BEGIN
    INSERT INTO DEMANDAS(PRECIOMAX, FECHADEMANDA, TIPO, NUM_MASCOTA, HABITACIONESREQUERIDAS, EMAIL, OID_O) VALUES  (W_PRECIO,W_FECHA,W_TIPO ,W_NUMMASCOTA,W_HABITACIONESREQUERIDAS,W_EMAIL, W_OIDO);
END;
/
